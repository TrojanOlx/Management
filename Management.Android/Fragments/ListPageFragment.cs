...
namespace Management.Android.Fragments
{
    ...
    "Yemen","Yugoslavia","Zambia","Zimbabwe"
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var listView = (ListView)view.FindViewById(Resource.Id.list_view);
            listView.Adapter = new ArrayAdapter<string>(Context, Resource.Menu.list_item, countries);
        ...
        {
            Toast.MakeText(Context, ((TextView)args.View).Text, ToastLength.Short).Show();
        }
    }
}